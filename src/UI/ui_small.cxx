...
Fl_Menu_Item menu_small_menu[] = {
 ...
 {_("TCPIP - TCI"), 0, (Fl_Callback*)cb_mnuTCPIP, 0, 0, FL_NORMAL_LABEL, 0, 14, 0},
...
Fl_Group *small_main_group(int X, int Y, int W, int H)
{
	...
	btn_KX3_IFsh = new Fl_Button(2, 265, 50, 18, _("Cntr"));
	...
	btn_KX3_A2B = new Fl_Button(265, 62, 52, 20, _("A->B"));
	...
	btn_K3_swapAB = new Fl_Button(212, 62, 52, 20, _("A / B"));
	btn_K3_swapAB->tooltip(_("Swap Vfo A / Vfo B"));
	btn_K3_swapAB->down_box(FL_DOWN_BOX);
	btn_K3_swapAB->labelsize(12);
	btn_K3_swapAB->callback((Fl_Callback*)cb_btn_K3_swapAB);
	btn_K3_swapAB->hide();

	btn_K3_A2B = new Fl_Button(265, 62, 52, 20, _("A -> B"));
...
//	362, 325, 60, 18, _("PTT"));
	...
	sm_grp1 = new Fl_Group(1, 62, 210, 60);
		...
		grpMeters->box(FL_FLAT_BOX);
			...
			sldrIDD = new Fl_SigBar(5, 85, 200, 6);
			...
			sldrVoltage = new Fl_SigBar(5, 92, 200, 6);
			...
			scaleVoltage = new Fl_Box(3, 99, 206, 20);
	...
	tabs550 = new Fl_Tabs(0, 0, small_mainW, gph);
{
		...
		tt550_Rx = new Fl_Group(0, 24, small_mainW, gph - 24, _("RX"));
			...
			cbo_tt550_nb_level->labelsize(12);
			...
			cbo_tt550_agc_level->labelsize(12);
		...
		tab7610 = new Fl_Group(0, 24, small_mainW, gph - 24, _("IC7610"));
{
			...
			ic7610_digi_sel_val->labelsize(12);
